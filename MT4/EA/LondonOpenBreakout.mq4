...
// ----- Parameters -----
input TradingTimes tradeOpenTime = LONDON_OPEN; // Trade time
input ENUM_TIMEFRAMES timeFrame = PERIOD_CURRENT; // Time period per bar
...
input int tradeOpenBarOffset = 2; // The number of bars to start trading before or after trade open time
...
//
   ...
   if (referenceBarIndex >= 1 && !isReferenceSet){   
      ...
      takeProfitSpread = NormalizeDouble(0.0005, 5);
